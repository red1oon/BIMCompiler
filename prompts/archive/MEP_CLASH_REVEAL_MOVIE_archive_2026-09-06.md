# ⚠ DO NOT REMOVE — ARCHIVE of prompts/MEP_CLASH_REVEAL_MOVIE.md lines 1-1878 (2026-08-07 through session-3 close, 2026-09-06), consolidated out of the live file on 2026-09-06 because it had grown past 2400 lines. Everything here is CLOSED/MERGED/WITNESSED history — read it only when you need the full derivation behind something the live file's compact recap only summarizes. The live file's own §PENDING section onward (its active/in-flight work) was NOT touched by this consolidation.
